...
<head>
    ...
    <style>
        ...
        .btn-custom {
            background-color:rgb(71, 159, 237); /* Gray color */
            border-color: #6c757d;
        }
            ...
            <div class="col-md-4 mb-4" id="lowongan-1">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><b>Tanggal Batas Lamaran:</b> 1 Januari 2024</p>
            ...
            <div class="col-md-4 mb-4" id="lowongan-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><b>Tanggal Batas Lamaran:</b> 11 September 2024</p>
                        <a href="#" class="btn btn-custom">Lamar Sekarang</a>
